...
class  BugTuple(models.Model):
    ...
    priority = models.CharField("priority",max_length=10) # bug优先级： CRITICAL/MEDIUM/MEDIUM+/LOW/UNDECIDED"
    severity = models.CharField("severity",max_length=10) # bug严重程度限定值： CRITICAL/MAJOR/NORMAL/MINOR/ENHANCEMENT"
    QA = models.CharField("QA",max_length=50) # bug所属的QA(质量保证负责人)
    ccList = models.CharField("ccList",max_length=200) # bug抄送人员(一个列表)
